...
helpx_learn_topic: ""
helpx_tags: ""
title: Normali piegati da trama
...
Normali piegati da fornaio trama calcola una texture che descrive la direzione media della luce ambiente. Questo fornaio è derivato dall&#39;Occlusione [Ambient dal fornaio Mesh](../../bakers-settings/ambient-occlusion-from/ambient-occlusion-from-mesh.md).
...
| **Ignora carattere di sfondo** | Se questa opzione è attivata, i raggi di occlusione ignorano i colpi su una superficie posteriore (se la normale di poly alto è orientata in direzione opposta a quella del poly basso da cui viene sparato il raggio). Nella maggior parte dei casi questa impostazione deve essere abilitata per evitare artefatti. |
...
| **Orientamento normale** | Controlla il formato normale della texture di output se **Tipo mascherino** è impostato su Spazio tangente.Valori possibili:<ul data-preserve-html="true"><li data-preserve-html="true"><strong>OpenGL</strong> <strong> <br/></strong></li><li data-preserve-html="true"><strong>DirectX</strong> (impostazione predefinita)<strong> <br/></strong></li></ul> |

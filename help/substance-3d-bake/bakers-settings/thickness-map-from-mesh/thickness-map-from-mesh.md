...
breadcrumb-title: ''
description: Genera mappe di thickness colando i raggi verso l'interno dalle superfici mesh per utilizzarli negli shader SSS e nella mascheratura.
...
La mappa del Thickness da mesh è molto simile al fornaio di occlusione ambientale, ma proietta raggi dalla superficie della mesh all&#39;interno. Questa texture può essere utilizzata in uno shader di dispersione delle superfici secondarie (SSS) o per mascherare le texture.

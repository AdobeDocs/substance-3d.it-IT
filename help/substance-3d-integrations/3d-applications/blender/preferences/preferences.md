---
helpx_url: "https://helpx.adobe.com/it/substance-3d-integrations/3d-applications/blender/preferences.html"
breadcrumb-title: ''
...
<b>Cicli aggiornamento automatico texture</b>: forza l’aggiornamento della texture nel riquadro di visualizzazione 3D durante l’utilizzo della vista di rendering dei cicli.
...
<b>Cartella temporanea </b>: questa cartella sarà la posizione predefinita in cui vengono memorizzate le texture prima del salvataggio di un file per la prima volta.
...
<b>Al momento del salvataggio, copia le texture in</b> - Quando si salva per la prima volta un file, le texture nella cartella temporanea verranno copiate in questa posizione. La variabile $matname viene utilizzata per creare sottocartelle per ciascun materiale.

<b>Predefinito shader</b>: imposta il predefinito shader utilizzato per la creazione di materiali di fusione da file di sostanze. Può essere impostato su standard per la mappatura basata su UV o la proiezione per la mappatura basata su proiezione a scatola, sfera e cilindro.
...
<b>Intensità di emissione</b>: valore predefinito per l&#39;Intensità di emissione nel nodo BSDF con principi.

<b>Fusione proiezione</b>: imposta la quantità di fusione tra angoli per gli ombreggiatori del metodo di proiezione.

<b>AO Mix</b> - Quando Occlusione ambiente è abilitato come output, questo valore determina il valore predefinito del fattore del nodo MixRGB utilizzato per combinare il colore di base e le texture dell’Occlusione ambiente.

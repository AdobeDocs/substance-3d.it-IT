...
| BakeOutputsOfSelectedGraph | Blocca su disco le bitmap dell&#39;istanza del grafico selezionata |  |  | ***Parametro stringa:* filePath &#x200B;** Directory del percorso principale in cui scrivere le immagini&#x200B;***Parametro stringa &#x200B;***: **imageFormatExtension** Estensione/formato del file in cui scrivere le immagini |

...
| **EnableInstanceOutputs** | Input: **SubstanceGraphInstance** - Istanza del grafico contenente l&#39;output per abilitare Input: **OutputIndices** (matrice int32) - Indici degli output che si desidera abilitare. | Se precedentemente disattivato, crea gli output di texture di **SubstanceGraphInstance** passati. Questa funzionalità ha la stessa funzionalità dell&#39;abilitazione dell&#39;output dall&#39;editor **SubstanceGraphInstance**. *NOTA: questa operazione non aggiornerà il materiale con la texture appena creata. Questo problema deve essere gestito impostando un parametro di campionatore in fase di esecuzione utilizzando il nuovo output.* |

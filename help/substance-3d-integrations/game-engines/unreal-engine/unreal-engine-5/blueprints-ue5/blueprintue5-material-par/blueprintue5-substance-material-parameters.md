...
Per modificare i parametri float, color(float4) e Boolean substance, utilizzare il [nodo Virgola mobile di input](https://helpx.adobe.com/substance-3d/unlisted/documentation/integrations/blueprint-node-reference-151584784.html).

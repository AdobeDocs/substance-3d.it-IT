...
| **EnableInstanceOutputs** | Input: **SubstanceGraphInstance** - Istanza del grafico contenente l&#39;output per abilitare Input: **OutputIndices** (matrice int32) - Indici degli output che si desidera abilitare. (Soggetto a modifica) | Se precedentemente disattivato, vengono creati gli output di texture di **SubstanceGraphInstance** passati. Questa funzionalità consente di abilitare un output dall&#39;editor **SubstanceGraphInstance**. *NOTA: questa operazione non aggiornerà il materiale con la nuova texture creata. Questo problema deve essere gestito impostando un parametro di campionatore in fase di esecuzione utilizzando il nuovo output.* |

...
breadcrumb-title: ''
description: Utilizzate i nodi di Blueprint in Unreal Engine 4 per controllare i materiali delle Substance in fase di runtime per i flussi di lavoro dei materiali dinamici.
...
In questa sezione viene descritto come utilizzare i materiali Substance e [Blueprint](https://docs.unrealengine.com/en-US/Engine/Blueprints/GettingStarted/index.html) in Unreal Engine.
